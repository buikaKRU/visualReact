...
| -------------------- | ------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------- | --------------- |
| `someOtherString`    | `some-other-string` | It is not so importent, it's for testing purpose only  [ {value: 'warning', description :'for warnings'}, {value: 'success', description :'for succeeded notifications'}, ]                                   | `"somethingElse" \| "success" \| "warning"` | `undefined`     |
